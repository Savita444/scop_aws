...
Route::get('/', ['as' => '/', 'uses' => 'App\Http\Controllers\Website\ContactUs\ContactUsController@getContactUs']);
Route::get('/secondform/{add_contact}', ['as' => 'secondform', 'uses' => 'App\Http\Controllers\Website\ContactUs\ContactUsController@secondform']);
Route::post('/add-contactus', ['as' => 'add-contactus', 'uses' => 'App\Http\Controllers\Website\ContactUs\ContactUsController@addContactUs']);

Route::get('/edit-second-form/{user_id}', ['as' => 'edit-second-form', 'uses' => 'App\Http\Controllers\Website\ContactUs\ContactUsController@edit']);

Route::post('/second-form', ['as' => 'second-form', 'uses' => 'App\Http\Controllers\Website\ContactUs\ContactUsController@updatesecondSecondForm']);
